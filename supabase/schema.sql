...
ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "public_users_pinned_post_fkey" FOREIGN KEY ("pinned_post") REFERENCES "public"."users"("id") ON DELETE SET NULL;

ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "public_users_program_id_fkey" FOREIGN KEY ("program_id") REFERENCES "public"."programs"("id");

ALTER TABLE ONLY "public"."rooms_users"
    ADD CONSTRAINT "rooms_users_last_seen_chat_id_fkey" FOREIGN KEY ("last_seen_chat_id") REFERENCES "public"."chats"("id");
