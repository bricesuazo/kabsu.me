...
CREATE TABLE IF NOT EXISTS "public"."prof_posts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."prof_posts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."prof_posts_programs" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."prof_posts_programs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."prof_posts"
    ADD CONSTRAINT "prof_posts_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."prof_posts_programs"
    ADD CONSTRAINT "prof_posts_programs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."prof_posts_programs"
    ADD CONSTRAINT "prof_posts_programs_prof_post_id_fkey" FOREIGN KEY ("prof_post_id") REFERENCES "public"."prof_posts"("id");



ALTER TABLE ONLY "public"."prof_posts_programs"
    ADD CONSTRAINT "prof_posts_programs_program_id_fkey" FOREIGN KEY ("program_id") REFERENCES "public"."programs"("id");



ALTER TABLE ONLY "public"."prof_posts"
    ADD CONSTRAINT "prof_posts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
GRANT ALL ON TABLE "public"."prof_posts" TO "anon";
GRANT ALL ON TABLE "public"."prof_posts" TO "authenticated";
GRANT ALL ON TABLE "public"."prof_posts" TO "service_role";



GRANT ALL ON TABLE "public"."prof_posts_programs" TO "anon";
GRANT ALL ON TABLE "public"."prof_posts_programs" TO "authenticated";
GRANT ALL ON TABLE "public"."prof_posts_programs" TO "service_role";
